###################################################################
# STACKORED KAFKA COMPOSE TEMPLATE
###################################################################

services:
  zookeeper:
    image: confluentinc/cp-zookeeper:latest
    container_name: stackored-zookeeper
  ...
  kafka:
    ...
    container_name: stackored-kafka
    restart: unless-stopped
    depends_on:
      - zookeeper
    ports:
    ...
    environment:
      ...
      KAFKA_ADVERTISED_LISTENERS: PLAINTEXT://stackored-kafka:9092,PLAINTEXT_HOST://localhost:29092
